...
#configFilePath <- arguments$config_file
...
# Testdata
# Example1
sampleAnnotationCSV = "sample_annotations.csv"
readCountFile = "read_counts.tsv"
results_dir = "/data/scratch/kvalem/projects/2021/honda_project_2021/05-results/40_single-cell-sorted-cd8/13_january_2025/runDESeq2_ICBI/"
paired_grp = NULL
prefix = "deseq2"
plot_title = NULL
nfcore=FALSE
...
contrast = c("condition", "11mix", "10mix")
gene_id_type = "ENSEMBL"
covariate_formula = "+ origin"
fdr_cutoff = 0.1
fc_cutoff = 1
fc_cutoff = 0.585
...
colnames(allSampleAnno)[1] <- "sample_names"
